package com.gofind.gofind.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.gofind.gofind.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.gofind.gofind.security.DomainUserDetailsService", "createSpringSecurityUser");
