...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './piece.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PIECE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PIECE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PIECE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PIECE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PIECE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PIECE actions', async () => {
      const arg = 42666;
