...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './trajet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAJET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRAJET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRAJET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRAJET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRAJET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRAJET actions', async () => {
      const arg = 42666;
